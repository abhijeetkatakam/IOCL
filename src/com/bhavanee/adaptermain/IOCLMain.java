	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			if(tempResultSet!=null && rowCount!=0)
			{
				...
				ioclServiceIntegrations.createAndSendAPIRequest();
			}
			else
			{
				logger.info("No Records Found in dataBase for the date::"+currDate+" and time:::"+adapterProperties.getProperty("Time")+"!!!");
			}
		}
